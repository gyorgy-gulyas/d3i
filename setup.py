...
setup(
    name='d3i',  # The name of the package. This is what users will install via pip.
    version='0.1.0',     # The version of the package, update as needed.
    ...
    entry_points={
        'console_scripts': [
            'd3i = d3i.__main__:main',  # When 'd3i' is run, it will call the main() function from 'd3i.__main__'.
        ],
    },
