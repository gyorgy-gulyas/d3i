...
class dotnet_configuration:
    def __init__(self, configuration: Dict[str, str], output_dir: str):
        ...
        self.__read_fileHeader__(configuration)
        self.__read_defaultUsings__(configuration)
        self.__read_createFolderStructure__(configuration)
        self.__read_eachClassSeparateFile__(configuration)

    def __read_fileHeader__(self, configuration: Dict[str, str]):
        self.fileHeader: str = """
// <auto-generated>
...
// </auto-generated>"""
    ...
    def __read_defaultUsings__(self, configuration: Dict[str, str]):
    ...
    def __read_createFolderStructure__(self, configuration: Dict[str, str]):
    ...
    def __read_eachClassSeparateFile__(self, configuration: Dict[str, str]):
