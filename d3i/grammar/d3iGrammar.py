...
def serializedATN():
    return [
        ...
        103,1,0,0,0,106,107,5,13,0,0,107,108,3,74,37,0,108,3,1,0,0,0,109,
        ...
        124,1,0,0,0,127,128,5,14,0,0,128,129,5,46,0,0,129,133,5,6,0,0,130,
        ...
        0,192,194,1,0,0,0,193,191,1,0,0,0,194,195,5,23,0,0,195,197,5,46,
        ...
        1,0,0,0,240,238,1,0,0,0,241,242,5,16,0,0,242,244,5,46,0,0,243,245,
        ...
        1,0,0,0,288,289,5,17,0,0,289,291,5,46,0,0,290,292,3,84,42,0,291,
        ...
        336,5,18,0,0,336,337,5,46,0,0,337,341,5,6,0,0,338,340,3,34,17,0,
        ...
        349,347,1,0,0,0,349,348,1,0,0,0,350,35,1,0,0,0,351,353,5,26,0,0,
        ...
        0,0,365,366,1,0,0,0,366,368,1,0,0,0,367,365,1,0,0,0,368,369,5,19,
        ...
        1,0,0,0,413,415,1,0,0,0,414,412,1,0,0,0,415,416,5,25,0,0,416,417,
        ...
        1,0,0,0,431,429,1,0,0,0,432,433,5,20,0,0,433,434,5,46,0,0,434,438,
        ...
        1,0,0,0,461,462,5,21,0,0,462,463,5,46,0,0,463,467,5,6,0,0,464,466,
        ...
        5,22,0,0,557,558,5,46,0,0,558,562,5,6,0,0,559,561,3,62,31,0,560,
        ...
        1,0,0,0,641,639,1,0,0,0,642,643,5,24,0,0,643,644,5,46,0,0,644,646,
...
class d3iGrammar ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'.'", "','", "':'", "'('", "')'", "'{'", 
                     "'}'", "'['", "']'", "'@'", "'=>'", "'|'", "'import'", 
                     "'domain'", "'context'", "'event'", "'entity'", "'aggregate'", 
                     "'view'", "'service'", "'interface'", "'acl'", "'valueobject'", 
                     "'enum'", "'repository'", "'root'", "'or'", "'inherits'", 
    ...
    symbolicNames = [ "<INVALID>", "DOT", "COMMA", "SEMI", "LPAREN", "RPAREN", 
                      ...
                      "ARROW", "PIPE", "IMPORT", "DOMAIN", "CONTEXT", "EVENT", 
    ...
    def d3(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 351843720905728) != 0):
                self.state = 92
                self.domain()
                self.state = 97
                self._errHandler.sync(self)
    ...
    def context(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 281475043558400) != 0):
                self.state = 164
    ...
    def value_object(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 351843746055168) != 0):
                self.state = 200
    ...
    def aggregate(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 281475069117440) != 0):
                self.state = 338
    ...
    def service(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 351843746120704) != 0):
                self.state = 435
