...
def serializedATN():
    return [
        ...
        112,1,0,0,0,111,109,1,0,0,0,112,113,5,21,0,0,113,114,3,80,40,0,114,
        ...
        1,0,0,0,132,130,1,0,0,0,133,134,5,17,0,0,134,135,5,46,0,0,135,139,
        ...
        1,0,0,0,248,249,5,16,0,0,249,251,5,46,0,0,250,252,3,90,45,0,251,
        ...
        296,5,20,0,0,296,298,5,46,0,0,297,299,3,90,45,0,298,297,1,0,0,0,
        ...
        5,18,0,0,343,345,5,46,0,0,344,346,3,90,45,0,345,344,1,0,0,0,345,
        ...
        466,1,0,0,0,469,470,5,23,0,0,470,471,5,46,0,0,471,472,5,3,0,0,472,
        ...
        487,5,24,0,0,487,488,5,46,0,0,488,492,5,6,0,0,489,491,3,54,27,0,
        ...
        0,0,512,513,1,0,0,0,513,515,1,0,0,0,514,512,1,0,0,0,515,516,5,22,
        ...
        0,0,0,696,697,5,19,0,0,697,698,5,46,0,0,698,700,5,6,0,0,699,701,
...
class d3iGrammar ( Parser ):
    ...
    def context(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 281475107349504) != 0):
                self.state = 170
